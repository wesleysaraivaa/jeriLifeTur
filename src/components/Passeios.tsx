  ...
  return (
    <section className="relative bg-[url('./assets/images/FUNDO-PASSEIOS.png')] bg-cover bg-center">
      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        <h1 className="text-[clamp(2.2rem,6vw,4rem)] mt-10 mb-20 text-center text-white ">
          <span className="font-bold">Oferecemos passeios privativos </span>
          ou compartilhados em:
        </h1>
        <div className="flex flex-col items-center md:flex-row md:flex-wrap justify-center gap-8 md:gap-10 lg:gap-16 mt-10">
          <div className="relative bg-custom-blue-light rounded-2xl flex w-full max-w-[360px] md:w-110 h-20 md:h-24 items-center justify-start px-6 md:px-8 mb-4">
            <div className="absolute inset-0 overflow-hidden rounded-2xl">
              <p className="absolute left-2 top-1/2 -translate-y-1/2 font-caesar-regular font-bold text-5xl md:text-6xl text-custom-blue/20 pointer-events-none select-none">
                BUGGY
              </p>
            </div>
            <p className="relative z-10 font-caesar-regular text-3xl md:text-4xl text-white">
              BUGGY
            </p>
            <img
              src={Buggy}
              alt="Buggy"
              className="absolute z-20 bottom-0 right-2 md:right-4 w-32 md:w-40"
            />
          </div>
          <div className="relative bg-custom-blue-light rounded-2xl flex w-full max-w-[360px] md:w-110 h-20 md:h-24 items-center justify-start px-6 md:px-8 mb-4">
            <div className="absolute inset-0 overflow-hidden rounded-2xl">
        ...
        <div className="w-full flex flex-col lg:block relative rounded-[30px] md:rounded-[50px] shadow-2xl overflow-hidden group">
          ...
          <div className="lg:bg-[url('./assets/images/KiteTripseDownwind.png')] bg-cover bg-center w-full min-h-fit lg:min-h-137.5 flex items-center justify-end p-5 sm:p-8 md:p-12 lg:p-16">
            <div className="w-full lg:max-w-xl bg-custom-blue/80 lg:bg-white/10 lg:backdrop-blur-md p-6 sm:p-8 md:p-10 rounded-[25px] md:rounded-3xl lg:border lg:border-white/20 lg:shadow-2xl text-white">
              <h2 className="text-[clamp(2rem,5vw,3rem)] font-caesar-regular mb-4 leading-tight drop-shadow-lg uppercase">
